...
RSpec.describe TeamsController, type: :controller do
  ...
  let(:valid_attributes) {
    {name: "dogs who code", course_id: @course.id, id: 1}
  }
  ...
  describe "GET #show" do
    it "assigns the requested team as @team" do
      team = Team.create! valid_attributes
      get :show, {:course_id => @course.id, :id => team.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested team as @team" do
      team = Team.create! valid_attributes
      get :edit, {:course_id => @course.id,:id => team.to_param}, valid_session
      expect(assigns(:team)).to eq(team)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assigns the requested team as @team" do
        team = Team.create! valid_attributes
        put :update, {:course_id => @course.id, :id => team.to_param, :team => valid_attributes}, valid_session
        expect(assigns(:team)).to eq(team)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the team as @team" do
        team = Team.create! valid_attributes
        put :update, {:course_id => @course.id, :id => team.to_param, :team => invalid_attributes}, valid_session
        expect(assigns(:team)).to eq(team)
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested team" do
      team = Team.create! valid_attributes
      expect {
        delete :destroy, {:course_id => @course.id, :id => team.to_param}, valid_session
      }.to change(Team, :count).by(-1)
    end
  end
